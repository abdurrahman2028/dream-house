  ...
  return (
    <div className="">
      ...
      <div className="lg:pt-0 pt-20">
        <div className="absolute top-0 blur-[20px] bg-neutral-100/10 lg:px-52 h-screen w-full flex items-center justify-center "></div>
        <section
          className="lg:h-screen bg-cover bg-no-repeat lg:bg-[center_top_-5rem] bg-[center_top_0rem]"
            ...
            <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
              <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                ...
                <div className="mt-8 lg:w-1/2 lg:mx-6">
                  <div className="relative w-full px-8 py-10 mx-auto overflow-hidden bg-zinc-200/60 shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                    ...
                    <form className="mt-6">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className="block w-full px-5 py-3 mt-2 text-gray-700 bg-zinc-200/50 border border-gray-200/20 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                        />
                      </div>
                      ...
                      <div className="w-full mt-6">
                        ...
                        <textarea
                          className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-zinc-200/50 border border-gray-200/20 rounded-md md:h-48 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                          placeholder="Message"
                        ></textarea>
                      </div>
